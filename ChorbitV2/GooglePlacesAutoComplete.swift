...
public class GooglePlacesAutocomplete: UINavigationController {
    ...
    public convenience init(apiKey: String, placeType: PlaceType = .All, isAddressOnly: Bool = false) {
...
extension GooglePlacesAutocompleteContainer: UISearchBarDelegate {
    ...
    private func getPlaces(searchString: String, isAddressOnly: Bool = false) {
        var params = [
            "input": searchString,
